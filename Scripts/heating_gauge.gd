...
@export var heat_increase_rate: float = 10.0  # Heat gained per shot
@export var heat_cool_rate: float = 5.0  # Heat lost per second
@export var overheat_penalty_time: float = 2.0  # Time you cannot shoot when overheated
...
func _ready() -> void:
	...
	gun_node = Global.playerInstance.get_node("gun")
